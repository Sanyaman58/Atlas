...
public class PageTools extends AllureLogger {
    ...
    protected boolean shouldBe(By by, Object... args){
        return $(byLocator(by,args)).isDisplayed();

    }

    protected void scrollIntoViewSmoothly(By by, Object... args){
        $(byLocator(by,args)).scrollIntoView("{behavior: \"smooth\", block: \"end\", inline: \"nearest\"}");
    }
...
//    }
    ...
    public boolean isDisabled(By by, Object... args){
        return !$(byLocator(by, args)).isEnabled();
    }

    protected void doubleClick(By by, Object... args) {
        logInfo(getPreviousMethodNameAsText() + ", element --> " + byLocator(by, args));
        shouldBe(Condition.exist, by, args).doubleClick();
    }
    ...
    protected boolean checkForElementVisibility(By by, Object... args) {
        return shouldBe(by, args);
    }
    ...
    protected boolean isConditionWithNoLog(Condition condition, By by, Object... args) {
        //logInfo(getPreviousMethodNameAsText() + ", condition --> " + condition.getName() + ", element --> " + byLocator(by, args));
        return getSelenideElement(by, args).is(condition);
    }
    ...
    protected boolean isElementExistsWithNoLog(By by, Object... args) {
        //logInfo(getPreviousMethodNameAsText() + ", element --> " + byLocator(by, args));
        return isConditionWithNoLog(Condition.exist, by, args);
    }

    protected boolean isElementVisibleWithNoLog(By by, Object... args) {
        //logInfo(getPreviousMethodNameAsText() + ", element --> " + byLocator(by, args));
        return isConditionWithNoLog(Condition.visible, by, args);
    }
    ...
    protected List<WebElement> getWebElements(By by, Object... args) {
        return WebDriverRunner.getWebDriver().findElements(byLocator(by, args));
    }
    ...
    public boolean isReadOnly(By by, Object... args){
        return Boolean.parseBoolean($(byLocator(by, args)).getAttribute("readonly"));
    }

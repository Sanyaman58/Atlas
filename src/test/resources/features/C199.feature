...
Feature: C199
  ...
  Scenario: Verify the displaying of the complex query criteria of the requirement
    ...
    And Verify that newly created requirement contains "(RES1 != VT) and ((FIN1 = Y and FIN1.1 = Y and FIN1.1.2 = Y and PRO4.12 = N and PRO1.1 = N) or (FIN1 = N and FIN1.1.2 = Y and FIN1.1.3 = Y and PRO1.1 = N and PRO4.12 = N and FIN1.1.6 = Y) or (FIN1 = Y and FIN1.1.3 = Y and FIN1.1.4 = N and FIN1.1.5 = N and PRO4.12 = N and PRO1.1 = N) or (FIN1 = Y and FIN1.1.2 = Y and FIN1.1.1 = Y and FIN1 = Y and PRO4.12 = N and FIN1.1 = N))" selector criteria
    ...
    And Verify that log containing "(RES1 != VT) and ((FIN1 = Y and FIN1.1 = Y and FIN1.1.2 = Y and PRO4.12 = N and PRO1.1 = N) or (FIN1 = N and FIN1.1.2 = Y and FIN1.1.3 = Y and PRO1.1 = N and PRO4.12 = N and FIN1.1.6 = Y) or (FIN1 = Y and FIN1.1.3 = Y and FIN1.1.4 = N and FIN1.1.5 = N and PRO4.12 = N and PRO1.1 = N) or (FIN1 = Y and FIN1.1.2 = Y and FIN1.1.1 = Y and FIN1 = Y and PRO4.12 = N and FIN1.1 = N))" description text is displayed on the [Activity Logs] page
    Then Click on the [Configuration] sidebar button on Lighthouse
    Then Select "AB Test" client from the client dropdown

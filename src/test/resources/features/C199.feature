...
Feature: C199
  ...
  Scenario: Verify the displaying of the complex query criteria of the requirement
    ...
    And Verify that newly created requirement contains "(RES1 != VT) and ((FIN1 = Y and FIN1.1 = Y and POS1 = Y and PRO4.2 = N and PRO3.1 = N) or (FIN1 = N and POS1 = Y and POS1.11 = Y and PRO3.1 = N and PRO4.2 = N and POS1.1.4 = Y) or (FIN1 = Y and POS1.11 = Y and POS1.1 = N and POS1.1.9 = N and PRO4.2 = N and PRO3.1 = N) or (FIN1 = Y and POS1 = Y and FIN1.2 = Y and FIN1 = Y and PRO4.2 = N and FIN1.1 = N))" selector criteria
    ...
    And Verify that log containing "(RES1 != VT) and ((FIN1 = Y and FIN1.1 = Y and POS1 = Y and PRO4.2 = N and PRO3.1 = N) or (FIN1 = N and POS1 = Y and POS1.11 = Y and PRO3.1 = N and PRO4.2 = N and POS1.1.4 = Y) or (FIN1 = Y and POS1.11 = Y and POS1.1 = N and POS1.1.9 = N and PRO4.2 = N and PRO3.1 = N) or (FIN1 = Y and POS1 = Y and FIN1.2 = Y and FIN1 = Y and PRO4.2 = N and FIN1.1 = N))" description text is displayed on the [Activity Logs] page
    Then Click on the [Configuration] sidebar button on Lighthouse
    Then Select "AR Pharma" client from the client dropdown
